    ...
    axios.get('http://localhost:3000/auth/logout')
      .then(result => {
        if (result.data.Status) {
          ...
          console.error('Logout unsuccessful:', result.data);
        }
      })
      .catch(error => {
        // Handle errors, including Axios errors and 404 Not Found
      ...
      <div className='row flex-nowrap'>
        <div className='col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark'>
          <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100'>
            <Link to="/dashboard"
              className='d-flex align-items-center pb-3 mb-md-1 mt-md-3 me-auto text-white text-decoration-none'
            >Nielit System
            </Link>
            <ul className='nav nav-pills flex-column mb-sm-auto mb-0 align-items-center' id='menu'>
              ...
              <li className='w-100'>
                <Link to="/dashboard/category" className='nav-link px-0 align-middle text-white'>
                  ...
                  <span className='ms-2 d-none d-sm-inline'>Categories</span></Link>
              </li>
              <li className='w-100'>
